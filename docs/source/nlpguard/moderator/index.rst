...
The **Moderator** modifies the original training dataset based on the protected attributes identified by the **Explainer** and **Identifier**.
Overview
--------

The **Moderator** works by:
- ..
- ..
...
.. code-block:: python
   ...
   from nlpguard.moderator import Moderator
